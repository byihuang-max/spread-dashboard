...
name: market-scanner
description: |
  全市场公告扫描器。每日自动扫描全市场上市公司公告，按关键词（并购/重组、处罚、增持、减持、定增、ST风险）分类汇总，推送飞书卡片。
  触发词：全市场公告、公告扫描、扫描公告、市场公告监控
---
...
```bash
cd ~/Desktop/gamt-dashboard/skills/market-scanner
...
# 只保存 JSON 不发飞书
python3 market_scanner.py --date 2026-05-12
```
...
```bash
# 每工作日 21:00 自动扫描
0 21 * * 1-5 cd /home/ubuntu/gamt-dashboard/skills/market-scanner && python3 market_scanner.py --send
```
