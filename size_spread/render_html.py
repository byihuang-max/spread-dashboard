...
:root{{--bg:#0a0a0a!important;--card-bg:#0a0a0a!important;--text:#ccc!important;--text-sub:#888!important;--border:#2a2a2a!important;--accent:#ff8c00!important}}
html,body{{background:#0a0a0a!important;color:#ccc!important;max-width:100%!important;width:100%!important;padding:16px 20px!important;font-family:'JetBrains Mono',SF Mono,monospace!important}}
.card,.ov-card{{background:#0a0a0a!important;border:1px solid #2a2a2a!important;border-radius:0!important;box-shadow:none!important;color:#ccc!important}}
.card-title,.ov-label,h1,h2,h3,h4,h5,h6{{color:#ff8c00!important;font-family:'JetBrains Mono',SF Mono,monospace!important}}
p,span,div,li,td,th,label,.ov-value,.ov-sub{{color:#ccc!important}}
.ov-value.pos{{color:#ff5252!important}}
.ov-value.neg{{color:#4caf50!important}}
...
button,.ss-tab,.barra-time-btn{{background:#1a1a1a!important;border:1px solid #333!important;color:#888!important;border-radius:0!important}}
button:hover,.ss-tab:hover,.barra-time-btn:hover{{color:#ccc!important;border-color:#555!important}}
.ss-tab.active,.barra-time-active{{background:#ff8c00!important;color:#000!important;border-color:#ff8c00!important}}
...
.tag{{background:#1a1a1a!important;border:1px solid #ff8c00!important;color:#ff8c00!important;border-radius:0!important}}
.tag.cool{{background:#1a1a1a!important;border-color:#3498db!important;color:#3498db!important}}
/* Barra 状态面板专项 */
#barra-status-panel table{{font-family:'JetBrains Mono',SF Mono,monospace!important;width:100%!important}}
#barra-status-panel tr{{border-bottom:1px solid #1a1a1a!important}}
#barra-status-panel tr:last-child{{border-bottom:none!important}}
#barra-status-panel th{{padding:8px 6px!important;font-weight:600!important;font-size:10px!important;letter-spacing:.5px!important;text-transform:uppercase!important;border-bottom:1px solid #2a2a2a!important;background:#0f0f0f!important}}
#barra-status-panel td{{padding:6px 6px!important;font-size:11px!important;border-color:#1a1a1a!important}}
#barra-status-panel tr:hover td{{background:#141414!important}}
#barra-status-panel td[style*="color:#e05555"]{{color:#ff5252!important}}
#barra-status-panel td[style*="color:#2ecc71"]{{color:#4caf50!important}}
#barra-status-panel div[style*="color:#e05555"]{{color:#ff5252!important}}
#barra-status-panel div[style*="color:#2ecc71"]{{color:#4caf50!important}}
#barra-status-panel div[style*="border-bottom:1px solid #f1f5f9"]{{border-bottom:1px solid #2a2a2a!important;border-left:3px solid #ff8c00!important;padding:8px 12px!important;background:#0f0f0f!important;color:#ff8c00!important;font-size:12px!important;font-weight:700!important;letter-spacing:.5px!important;margin-bottom:0!important}}
#barra-status-panel > div[style*="margin-bottom:12px"]{{background:#0a0a0a!important;border:1px solid #2a2a2a!important;margin-bottom:14px!important;padding:0!important;overflow:hidden!important}}
#barra-status-panel > div[style*="margin-bottom:12px"] > table{{padding:0 12px 12px!important;border-collapse:collapse!important}}
#barra-status-panel td[style*="color:#94a3b8"]{{color:#888!important}}
