...
function initCbCharts() {{
  ...
  var baseOpts = {{
    ...
    scales: {{
      ...
      y: {{ ticks: {{ color:'#64748b', font:{{size:9}} }}, grid:{{color:'#1a1a1a',tickBorderDash:[3,3]}} }}
    }}
  }};
  ...
  new Chart(document.getElementById('cb-chart-activity'), {{
    ...
    options: {{ ...baseOpts, scales: {{
      ...baseOpts.scales,
      y: {{ position:'left', ticks:{{color:'#64748b',font:{{size:9}}}}, grid:{{color:'#1a1a1a',tickBorderDash:[3,3]}} }},
  ...
  new Chart(document.getElementById('cb-chart-valuation'), {{
    ...
    options: {{ ...baseOpts, scales: {{
      ...baseOpts.scales,
      y: {{ position:'left', min:0, max:100, ticks:{{color:'#64748b',font:{{size:9}}}}, grid:{{color:'#1a1a1a',tickBorderDash:[3,3]}} }},
  ...
  new Chart(document.getElementById('cb-chart-delta'), {{
    ...
    options: {{ ...baseOpts, scales: {{
      ...baseOpts.scales,
      y: {{ min:0, max:1, ticks:{{color:'#64748b',font:{{size:9}}}}, grid:{{color:'#1a1a1a',tickBorderDash:[3,3]}} }}
    }} }}
  }});
